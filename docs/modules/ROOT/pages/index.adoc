...
ifeval::["{project_name}" == "Course Project Dash"]
[.lead]
{project_name} is a GitHub repository template providing a starting point for {feelpp} projects.
endif::[]
ifeval::["{project_name}" != "Course Project Dash"]
{project_name} is a {feelpp} project. It was created using the repository template https://github.com/feelpp/course-project-dash[`feelpp/course-project-dash`].
endif::[]
